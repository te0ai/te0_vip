<div id="wrap_<?php h($_['id']) ?>" class="form-group">
  <div class="form-file-area well">
    ...
    ?>
    <div class="media">
      <a class="form-file-bnr-href media-left btn btn-default" href="<?php h(_OB_HOME_.$_['file']['uuid']) ?>" target="_blank">
        <?php h($_['file']['ext']) ?>
    	</a>
      <div class="media-body">
        <h4 class="media-heading form-file-head"><?php h($_['file']['name']) ?></h4>
